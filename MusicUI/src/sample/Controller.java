...
//        this is how you would normally write this update statement:
//        we're just hard coding for now so we can demonstrate the concept without having
//        to make a javafx dialog box
//        final Artist artist = (Artist) artistTable.getSelectionModel().getSelectedItem();
